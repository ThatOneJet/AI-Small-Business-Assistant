...
> This repo is a monorepo — the Summit app lives in [`JetCore/Summit`](JetCore/Summit).
...
![Dashboard](JetCore/Summit/docs/dashboard.png)
...
![AI Optimize](JetCore/Summit/docs/ai-optimize.png)
...
![Ask the AI](JetCore/Summit/docs/ask-ai.png)
...
![Scan & Count](JetCore/Summit/docs/scanner-scan.png)
...
![Enroll products](JetCore/Summit/docs/scanner-enroll.png)
